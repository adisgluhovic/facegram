                    ...
                    <!--KORISNIK UPLOADUJE ZELJENU SLIKU-->
...
<body>
    <div class="wrapper-upload-pic">
        ...
        <!--POCETAK FORME GDJE KORISNIK UPLOADUJE SLIKE-->
    <form class="upload-picture" method="POST" action="functions/upload.pic.function.php" enctype="multipart/form-data">
        <label for="fajlovi">Insert your picture</label>
        <br>
